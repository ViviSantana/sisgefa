...
-- -----------------------------------------------------
-- Table `sisgefa`.`tipoterreno`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sisgefa`.`tipoterreno` (
  `codigo` CHAR(2) NOT NULL,
  `descricao` VARCHAR(45) NULL,
  PRIMARY KEY (`codigo`))
ENGINE = InnoDB;
...
-- Popula Tipoterreno
-- -----------------------------------------------------
INSERT INTO `sisgefa`.`tipoterreno` (`codigo`,`descricao`)VALUES("Pt", "Particular");
INSERT INTO `sisgefa`.`tipoterreno` (`codigo`,`descricao`)VALUES("Pb", "Público");
INSERT INTO `sisgefa`.`tipoterreno` (`codigo`,`descricao`)VALUES("T", "Terceiros");


-- -----------------------------------------------------
-- Table `sisgefa`.`motivo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sisgefa`.`motivo` (
  `codigo` CHAR(2) NOT NULL,
  `descricao` VARCHAR(45) NULL,
  PRIMARY KEY (`codigo`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Popula Motivo Solicitação
-- -----------------------------------------------------

INSERT INTO `sisgefa`.`motivo`(`codigo`,`descricao`)VALUES("C","Construção");
INSERT INTO `sisgefa`.`motivo`(`codigo`,`descricao`)VALUES("A", "Ampliar Imóvel");
INSERT INTO `sisgefa`.`motivo`(`codigo`,`descricao`)VALUES("RH", "Dano a Rede Hidráulica");
INSERT INTO `sisgefa`.`motivo`(`codigo`,`descricao`)VALUES("RE", "Proximidade Rede Elétrica");
INSERT INTO `sisgefa`.`motivo`(`codigo`,`descricao`)VALUES("RT", "Risco de Tombamento");
INSERT INTO `sisgefa`.`motivo`(`codigo`,`descricao`)VALUES("O", "Outro");

-- -----------------------------------------------------
-- Table `sisgefa`.`solicitacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sisgefa`.`solicitacao` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `bairro` VARCHAR(45) NULL,
  `pto_referencia` VARCHAR(100) NULL,
  `nomevulgar` VARCHAR(100) NULL,
  `qtdalvo` INT NULL,
  `justificativa` VARCHAR(100) NULL,
  `municipio_id` INT NOT NULL,
  `municipio_uf_codigo` VARCHAR(2) NOT NULL,
  `pessoa_id` VARCHAR(20) NOT NULL,
  `tipo_logradouro_codigo` VARCHAR(10) NOT NULL,
  `tipoterreno_codigo` CHAR(2) NOT NULL,
  `motivo_codigo` CHAR(2) NOT NULL,
  `status_codigo` CHAR(2) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_solicitacao_municipio_idx` (`municipio_id` ASC, `municipio_uf_codigo` ASC) VISIBLE,
  INDEX `fk_solicitacao_pessoa_idx` (`pessoa_id` ASC) VISIBLE,
  INDEX `fk_solicitacao_tipo_logradouro_idx` (`tipo_logradouro_codigo` ASC) VISIBLE,
  INDEX `fk_solicitacao_tipoterreno_idx` (`tipoterreno_codigo` ASC) VISIBLE,
  INDEX `fk_solicitacao_motivo_idx` (`motivo_codigo` ASC) VISIBLE,
  INDEX `fk_solicitacao_status_idx` (`status_codigo` ASC) VISIBLE,
  CONSTRAINT `fk_solicitacao_municipio`
    FOREIGN KEY (`municipio_id` , `municipio_uf_codigo`)
    REFERENCES `sisgefa`.`municipio` (`id` , `uf_codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_solicitacao_pessoa`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_solicitacao_tipo_logradouro`
    FOREIGN KEY (`tipo_logradouro_codigo`)
    REFERENCES `sisgefa`.`tipo_logradouro` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_solicitacao_tipoterreno`
    FOREIGN KEY (`tipoterreno_codigo`)
    REFERENCES `sisgefa`.`tipoterreno` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_solicitacao_motivo`
    FOREIGN KEY (`motivo_codigo`)
    REFERENCES `sisgefa`.`motivo` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_solicitacao_status`
    FOREIGN KEY (`status_codigo`)
    REFERENCES `sisgefa`.`status` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
-- ------------------------------------------------
